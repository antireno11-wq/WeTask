export const CLEANING_SCOPE_SERVICE_OPTIONS = [
  ...
  { value: "planchado", label: "Planchado", description: "Apoyo con planchado dentro del servicio." },
  { value: "lavado_ropa", label: "Lavado de ropa", description: "Lavado básico de ropa según acuerdo." },
...
export const CLEANING_TASK_INCLUDED_OPTIONS = [
  ...
  { value: "lavado_ropa", label: "Lavado de ropa" },
